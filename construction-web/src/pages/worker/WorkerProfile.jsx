...
export const WorkerProfile = () => {
  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        title="My Profile" 
        description="Manage your skills, experience, and contact details."
      />
      ...
      {isLoading ? (
        ...
        <SectionCard>
          <form className="max-w-xl space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-neutral-700 mb-1">Trade / Skill</label>
              <input type="text" defaultValue={profile?.skill || ""} className="w-full px-4 py-2 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-gold-500" />
            </div>
            <div className="pt-4">
