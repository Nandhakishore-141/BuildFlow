...
export function HomeownerRegisterPage() {
  ...
  return (
    <AuthLayout type="centered">
      <AuthCard className="max-w-md">
        <FormHeader
          title="Homeowner Signup"
          description="Create an account to monitor building budgets, view construction timelines, and get photo updates."
          showBackButton
