    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="col-span-1">
          ...
          <p className="text-sm text-neutral-500 mt-1">Update your company details and logo.</p>
        </div>
          ...
          <SectionCard>
            <form className="space-y-4">
              <div>
                ...
                <input type="text" defaultValue={user?.companyName || 'My Company'} className="w-full px-4 py-2 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-gold-500" />
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="col-span-1">
          ...
          <p className="text-sm text-neutral-500 mt-1">Update your password and secure your account.</p>
        </div>
