...
export function AuthLayout({ children, type = 'centered' }) {
  if (type === 'split') {
    return (
      <div className="min-h-screen flex bg-white font-sans">
        {/* Left Side: Illustration / Dark branding panel */}
        <div className="hidden lg:flex lg:w-1/2 bg-neutral-950 text-white relative items-center justify-center overflow-hidden p-16">
          {/* Background effects */}
          <div className="absolute inset-0 z-0">
            <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-gold-500/10 rounded-full blur-[120px]" />
            <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-gold-500/5 rounded-full blur-[80px]" />
            {/* Grid Pattern */}
            <div
          ...
          <div className="relative z-10 max-w-lg w-full flex flex-col justify-between h-full">
            ...
            <div className="my-auto py-12">
              <motion.div
                ...
                className="space-y-6"
              >
                <div className="inline-flex items-center gap-2 px-3 py-1.5 text-xs font-semibold text-gold-400 bg-neutral-900 border border-neutral-800 rounded-full">
              ...
              <div className="mt-12 relative flex items-center justify-center">
                ...
                <div className="absolute w-56 h-56 rounded-full border border-gold-500/10 animate-ping" />
                <div className="w-64 h-48 bg-neutral-900/60 backdrop-blur-md border border-neutral-800 rounded-2xl p-6 shadow-2xl relative">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 rounded-md bg-gold-500/20" />
                      <div className="h-2 w-16 bg-neutral-855 rounded" style={{ backgroundColor: '#171717' }} />
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="h-2 w-4/6 bg-neutral-800 rounded" />
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 md:p-16 bg-neutral-50/50">
  ...
  return (
    <div className="min-h-screen flex flex-col bg-neutral-50/50 relative overflow-hidden font-sans">
      {/* Background radial effects */}
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-gradient-radial from-gold-100/30 via-transparent to-transparent rounded-full blur-3xl" />
        {/* Grid pattern */}
        <div
